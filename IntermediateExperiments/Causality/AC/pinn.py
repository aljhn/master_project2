...
#true_data = scipy.io.loadmat("ac_true.mat")
#u_true = torch.array(true_data["uu"])
#t_true = torch.array(true_data["tt"])
#x_true = torch.array(true_data["x"])
#tt_true, xx_true = torch.meshgrid((t_true, x_true), indexing="xy")
#ttxx_true = torch.stack((tt_true.flatten(), xx_true.flatten()), dim=1)
